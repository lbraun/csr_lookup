...
## Running the app
To run the app locally, navigate to the root directory and run `npm start`. Once the server is running, go to http://localhost:8000/ in your browser and you should see the app's main page.
