# CSR Lookup
[![Build Status](https://travis-ci.org/lbraun/csr_lookup.svg?branch=master)](https://travis-ci.org/lbraun/csr_lookup)

Welcome! This is a simple app for rating companies based on their corporate social responsibility (CSR).

## Contributing

See the app's [project page](https://github.com/users/lbraun/projects/2) for issues that are ready to be picked up.
...
## Project documents
- [Proposal](https://github.com/lbraun/csr_lookup/blob/master/project_files/proposal.md)
- [Mock-ups](https://github.com/lbraun/csr_lookup/blob/master/project_files/mockups.pdf)
- [Approved requirements](https://github.com/lbraun/csr_lookup/blob/master/project_files/requirements.md)



_And now for the standard angular-seed readme..._
